...
class QuickMatchTestCase(TestCase):
    ...
    @patch("baghchal.views.get_all_games", return_value={"0000": {"status": "waiting", "player": {"goat": "", "tiger": "hero"}}})
    ...
    @patch("baghchal.views.get_all_games", return_value={"1111": {"status": "ongoing"}})
